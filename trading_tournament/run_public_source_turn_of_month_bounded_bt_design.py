...
from strategy_lab.research_os.research.public_source_turn_of_month_bounded_bt_design import run
        ...
        json.dumps(
            {
                ...
                "calendar_timing_convention_frozen": result["calendar_timing_convention_frozen"],
