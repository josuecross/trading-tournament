...
from strategy_lab.research_os.research.public_source_parabolic_sar_bounded_bt_design import run
        ...
        json.dumps(
            {
                ...
                "repository_standard_psar_utility_found": result["repository_standard_psar_utility_found"],
