...
from strategy_lab.research_os.research.public_source_bollinger_squeeze_intake_state_reconciliation import run
        ...
        json.dumps(
            {
                ...
                "final_bollinger_squeeze_status": result["final_bollinger_squeeze_status"],
                "single_source_intake_decision": result["single_source_intake_decision"],
                "batch_intake_decision": result["batch_intake_decision"],
                "setup_threshold_not_freezable": result["setup_threshold_not_freezable"],
                "directional_confirmation_not_source_backed_enough_to_freeze": result[
                ...
                "unrelated_dirty_file_count": result["unrelated_dirty_file_count"],
