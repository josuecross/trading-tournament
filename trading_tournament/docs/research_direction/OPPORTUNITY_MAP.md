...
Tier 1 update: `exploratory/crypto_spot_momentum/` now exists as a separate long-only spot crypto exploratory lane. It is non-final, excludes leverage/perpetuals/futures/margin/shorting, does not affect the ETF validated lane, and makes no real-money recommendation.
