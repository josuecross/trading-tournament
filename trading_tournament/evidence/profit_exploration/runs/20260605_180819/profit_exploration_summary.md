...
13. Sector top2 versus combo_SPY200d_GLD_50_50_v1:
  - Sector top2 beat combo on drawdown-aware v2 score: no (sector_top2_momentum_simple_v1 $-97.56 vs combo_SPY200d_GLD_50_50_v1 $141.13).
  - Sector top2 beat combo on original final_score: no (sector_top2_momentum_simple_v1 33.5584 vs combo_SPY200d_GLD_50_50_v1 72.5801).
  ...
  - Sector top2 beat combo on 90d worst drawdown: no (sector_top2_momentum_simple_v1 $-600.59 vs combo_SPY200d_GLD_50_50_v1 $-419.15).
14. Sector top2 versus asset_class_tsmom_top2_v1:
  - Sector top2 beat top2 on drawdown-aware v2 score: no (sector_top2_momentum_simple_v1 $-97.56 vs asset_class_tsmom_top2_v1 $54.36).
  - Sector top2 beat top2 on original final_score: no (sector_top2_momentum_simple_v1 33.5584 vs asset_class_tsmom_top2_v1 62.5715).
  ...
  - Sector top2 beat top2 on 90d worst drawdown: no (sector_top2_momentum_simple_v1 $-600.59 vs asset_class_tsmom_top2_v1 $-539.08).
15. Sector top2 versus SPY_200d_trend_model:
  - Sector top2 beat SPY_200d on drawdown-aware v2 score: no (sector_top2_momentum_simple_v1 $-97.56 vs SPY_200d_trend_model $-52.16).
  - Sector top2 beat SPY_200d on original final_score: no (sector_top2_momentum_simple_v1 33.5584 vs SPY_200d_trend_model 48.0222).
  ...
  - Sector top2 beat SPY_200d on 90d worst drawdown: no (sector_top2_momentum_simple_v1 $-600.59 vs SPY_200d_trend_model $-567.45).
16. Sector top2 versus QQQ dual momentum on stop-aware risk:
  - Sector top2 beat QQQ dual momentum on drawdown-aware v2 score: no (sector_top2_momentum_simple_v1 $-97.56 vs qqq_spy_gld_ief_dual_momentum_v1 $-80.32).
  - Sector top2 beat QQQ dual momentum on original final_score: no (sector_top2_momentum_simple_v1 33.5584 vs qqq_spy_gld_ief_dual_momentum_v1 65.2665).
  ...
  - Sector top2 beat QQQ dual momentum on 90d worst drawdown: yes (sector_top2_momentum_simple_v1 $-600.59 vs qqq_spy_gld_ief_dual_momentum_v1 $-678.34).
17. Sector top2 versus value/momentum factor rotation:
  - Sector top2 beat value/momentum factor rotation on drawdown-aware v2 score: no (sector_top2_momentum_simple_v1 $-97.56 vs value_momentum_factor_etf_rotation_v1 $22.55).
  - Sector top2 beat value/momentum factor rotation on original final_score: no (sector_top2_momentum_simple_v1 33.5584 vs value_momentum_factor_etf_rotation_v1 59.1912).
  ...
  - Sector top2 beat value/momentum factor rotation on 90d worst drawdown: no (sector_top2_momentum_simple_v1 $-600.59 vs value_momentum_factor_etf_rotation_v1 $-407.74).
...
- 30d: +300 0.0%; +400 0.0%; +600 0.0%; +900 0.0%; +1200 0.0%; stop 0.0%; median $3,005.29; p95 $3,178.72; worst drawdown $-548.52
- 60d: +300 5.0%; +400 2.5%; +600 0.0%; +900 0.0%; +1200 0.0%; stop 0.0%; median $3,003.44; p95 $3,198.22; worst drawdown $-550.07
- 90d: +300 12.5%; +400 2.5%; +600 2.5%; +900 0.0%; +1200 0.0%; stop 2.5%; median $3,093.90; p95 $3,289.84; worst drawdown $-600.59
- 180d: +300 42.5%; +400 35.0%; +600 10.0%; +900 0.0%; +1200 0.0%; stop 2.5%; median $3,149.53; p95 $3,491.43; worst drawdown $-870.19
...
11. Diversifier or too slow: too_slow_warning=false. Diversification cannot be accepted without enough target potential.
...
13. Managed-futures proxy versus combo_SPY200d_GLD_50_50_v1:
  - Managed-futures proxy beat combo on drawdown-aware v2 score: no (managed_futures_proxy_etf_trend_v1 $58.89 vs combo_SPY200d_GLD_50_50_v1 $141.13).
  - Managed-futures proxy beat combo on original final_score: no (managed_futures_proxy_etf_trend_v1 42.0004 vs combo_SPY200d_GLD_50_50_v1 72.5801).
  ...
  - Managed-futures proxy beat combo on 90d worst drawdown: yes (managed_futures_proxy_etf_trend_v1 $-353.86 vs combo_SPY200d_GLD_50_50_v1 $-419.15).
14. Managed-futures proxy versus asset_class_tsmom_top2_v1:
  - Managed-futures proxy beat top2 on drawdown-aware v2 score: yes (managed_futures_proxy_etf_trend_v1 $58.89 vs asset_class_tsmom_top2_v1 $54.36).
  - Managed-futures proxy beat top2 on original final_score: no (managed_futures_proxy_etf_trend_v1 42.0004 vs asset_class_tsmom_top2_v1 62.5715).
...
15. Managed-futures proxy versus SPY_200d_trend_model:
  - Managed-futures proxy beat SPY_200d on drawdown-aware v2 score: yes (managed_futures_proxy_etf_trend_v1 $58.89 vs SPY_200d_trend_model $-52.16).
  - Managed-futures proxy beat SPY_200d on original final_score: no (managed_futures_proxy_etf_trend_v1 42.0004 vs SPY_200d_trend_model 48.0222).
  ...
  - Managed-futures proxy beat SPY_200d on 90d worst drawdown: yes (managed_futures_proxy_etf_trend_v1 $-353.86 vs SPY_200d_trend_model $-567.45).
16. Managed-futures proxy versus GLD_buy_hold on risk-adjusted terms:
  - Managed-futures proxy beat GLD_buy_hold on drawdown-aware v2 score: yes (managed_futures_proxy_etf_trend_v1 $58.89 vs GLD_buy_hold $-66.51).
  - Managed-futures proxy beat GLD_buy_hold on original final_score: yes (managed_futures_proxy_etf_trend_v1 42.0004 vs GLD_buy_hold 35.4907).
...
17. Managed-futures proxy versus BIL on target potential:
  - Managed-futures proxy beat BIL on drawdown-aware v2 score: yes (managed_futures_proxy_etf_trend_v1 $58.89 vs BIL_cash_proxy $-5.35).
  - Managed-futures proxy beat BIL on original final_score: yes (managed_futures_proxy_etf_trend_v1 42.0004 vs BIL_cash_proxy 2.7476).
  ...
  - Managed-futures proxy beat BIL on 90d worst drawdown: no (managed_futures_proxy_etf_trend_v1 $-353.86 vs BIL_cash_proxy $-23.45).
18. Future candidate_exhaustive deserved: false. Current verdict: watchlist.
...
- 30d: +300 0.0%; +400 0.0%; +600 0.0%; +900 0.0%; +1200 0.0%; stop 0.0%; median $3,003.25; p95 $3,081.27; worst drawdown $-211.77
- 60d: +300 2.5%; +400 2.5%; +600 0.0%; +900 0.0%; +1200 0.0%; stop 0.0%; median $3,006.26; p95 $3,122.61; worst drawdown $-271.01
- 90d: +300 17.5%; +400 2.5%; +600 2.5%; +900 0.0%; +1200 0.0%; stop 0.0%; median $3,010.17; p95 $3,265.84; worst drawdown $-353.86
- 180d: +300 25.0%; +400 17.5%; +600 10.0%; +900 0.0%; +1200 0.0%; stop 0.0%; median $3,025.67; p95 $3,559.18; worst drawdown $-465.25
