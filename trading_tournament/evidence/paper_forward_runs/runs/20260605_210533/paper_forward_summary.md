...
- run_id: 20260605_210533
- output: `evidence/paper_forward_runs/runs/20260605_210533/`
...
| combo_SPY200d_GLD_50_50_v1 | parallel_observation_candidate_blocked | 3000.0000 | 0.0000 | activation_blocked_rule_hash_missing | activation_blocked_rule_hash_missing | SPY,GLD,BIL |
...
| combo_SPY200d_GLD_50_50_v1 | SPY | activation_blocked_rule_hash_missing | nan | Combo paper/demo observation activation is blocked because the canonical rule hash is missing from existing evidence. SPY_200d remains the frozen control and is not replaced. | rule_hash_missing |
| combo_SPY200d_GLD_50_50_v1 | GLD | activation_blocked_rule_hash_missing | nan | Combo paper/demo observation activation is blocked because the canonical rule hash is missing from existing evidence. SPY_200d remains the frozen control and is not replaced. | rule_hash_missing |
| combo_SPY200d_GLD_50_50_v1 | BIL | activation_blocked_rule_hash_missing | nan | Combo paper/demo observation activation is blocked because the canonical rule hash is missing from existing evidence. SPY_200d remains the frozen control and is not replaced. | rule_hash_missing |
...
| combo_SPY200d_GLD_50_50_v1 | activation_blocked_rule_hash_missing | nan | nan |
...
| 2026-05 | 2026-05-29 | combo_SPY200d_GLD_50_50_v1 | 3000.0000 | 300.0000 | 400.0000 | 600.0000 | 600.0000 | normal | activation_blocked_rule_hash_missing | Combo activation is blocked because canonical_rule_hash is missing; SPY_200d remains frozen control. |
...
| combo_SPY200d_GLD_50_50_v1 | nan | nan | nan | 3000.0000 | nan | activation_blocked_rule_hash_missing |
...
- combo_status: activation_blocked_rule_hash_missing
- combo_rule_hash_verified: False
- combo_canonical_rule_hash: missing
...
- activation_note: Full active combo observation is blocked unless the canonical rule hash is present and verified.
