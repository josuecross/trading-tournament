...
- Combo activation remains blocked when canonical_rule_hash is missing or when required cached data is stale; blocked/waiting rows are not trading signals.
