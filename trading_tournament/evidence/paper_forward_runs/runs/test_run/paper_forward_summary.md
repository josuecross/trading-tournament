...
- run_id: test_run
- output: `evidence/paper_forward_runs/runs/test_run/`
...
| --- | --- | --- | --- | --- | --- | --- |
| SPY_200d_trend_model | primary_watchlist_candidate | 3117.6185 | 0.0392 | active_observation | risk_on | SPY |
| SPY_buy_hold | aggressive_benchmark | 3117.6185 | 0.0392 | active_observation | hold_spy | SPY |
| BIL_cash_proxy | defensive_benchmark | 2998.5000 | -0.0005 | active_observation | hold_bil | BIL |
| current_no_cash_proxy_alpha_AB | strategy_control | 3117.6185 | 0.0392 | active_observation | unavailable | SPY |
...
| current_no_cash_proxy_alpha_AB |  | unavailable | nan | test unavailable | signal_snapshot_unavailable |
...
| --- | --- | --- | --- | --- | --- |
| SPY_200d_trend_model | normal | 3117.6185 | 182.3815 | 600.0000 | 0.0000 |
| SPY_buy_hold | normal | 3117.6185 | 182.3815 | 600.0000 | 0.0000 |
| BIL_cash_proxy | normal | 2998.5000 | 301.5000 | 600.0000 | 0.0000 |
| current_no_cash_proxy_alpha_AB | normal | 3117.6185 | 182.3815 | 600.0000 | 0.0000 |
...
| --- | --- | --- | --- | --- | --- |
| SPY_200d_trend_model | active_normal | normal | 0.0000 | 0.3921 | 0.2940 |
| SPY_buy_hold | active_normal | normal | 0.0000 | 0.3921 | 0.2940 |
| BIL_cash_proxy | active_normal | normal | 0.0000 | 0.0000 | 0.0000 |
| current_no_cash_proxy_alpha_AB | active_normal | normal | 0.0000 | 0.3921 | 0.2940 |
...
SPY_200d_trend_model is active_observation with equity $3,117.62. It is $182.38 from +$300 and $600.00 above the trailing stop. No real-money action is implied.
