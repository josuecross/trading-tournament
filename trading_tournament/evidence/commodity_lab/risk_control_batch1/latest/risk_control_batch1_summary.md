# Commodity Risk-Control Batch 1 Summary

overall_decision: `no_candidate_exhaustive_review`

base_commodity_verdict_correction: `research_sample_candidate_risk_budget_breach`

best_risk_control_candidate: `combo_plus_commodity_basket_80_20_v1`

1. Did any risk-control candidate reduce drawdown below the -$600 budget? `true`.
...
3. Did any improve stop-aware score versus base commodity? See benchmark comparison rows against `commodity_basket_tsmom_top2_v1`.
...
7. Did any candidate deserve candidate_exhaustive review? `false`.
