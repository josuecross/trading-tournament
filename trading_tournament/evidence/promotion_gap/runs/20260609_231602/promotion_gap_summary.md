...
- Dominant failure modes: watchlist_missing_diagnostics=24, blocked_survivorship_or_point_in_time_data=19, too_risky_drawdown_budget=17, duplicate_existing_leader=10, protected_frozen_control=8
...
| --- | --- | --- | --- | --- | --- |
| commodity_basket_tsmom_top2_200d_filter_v1 | mark_too_risky | too_risky_drawdown_budget | 30 | low_watchlist | research_sample_review |
| commodity_basket_tsmom_top2_v1 | mark_too_risky | too_risky_drawdown_budget | 30 | low_watchlist | research_sample_review |
| crypto_spot_equal_weight_200d_filter_v1 | mark_too_risky | too_risky_drawdown_budget | 30 | low_watchlist | research_sample_review |
| crypto_spot_tsmom_top1_cash_filter_v1 | mark_too_risky | too_risky_drawdown_budget | 30 | low_watchlist | research_sample_review |
