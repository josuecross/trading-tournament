...
- asset_class_tsmom_top2_v1 remains serious challenger
	...
	Preferred next action: create a combination-design implementation review or improve diagnostics; after Batch 1, review Historical Combination Batch 1 evidence before any further implementation. Do not tune the active combo, do not replace SPY_200d, and do not add random one-off ETF momentum variants.
