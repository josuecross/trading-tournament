...
- asset_class_tsmom_top2_v1 remains serious challenger
	...
	Preferred next action: create a commodity basket ETF momentum product/data review, using attribution diagnostics before any later candidate_exhaustive review. Continue to use attribution diagnostics before any future combination candidate_exhaustive review. Do not implement a strategy, download data, tune the active combo, replace SPY_200d, or add random one-off ETF momentum variants.
