...
- asset_class_tsmom_top2_v1 remains serious challenger
	...
	Preferred next action: complete commodity target-window/component diagnostics before any future commodity candidate_exhaustive prompt; product identity and wrapper/tax/roll-risk review remains required. Do not tune the active combo, replace SPY_200d, or add random one-off ETF momentum variants.
