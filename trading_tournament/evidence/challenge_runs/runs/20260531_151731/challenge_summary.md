...
- run_id: 20260531_151731
- output: `evidence/challenge_runs/runs/20260531_151731/`
...
ETF evidence summaries, ETF benchmarks.
...
+$300 and +$400 are possible in this focused ETF challenge view, but the current finalist is still not validated. SPY buy-and-hold and the SPY 200-day trend benchmark have higher 90-day target-before-stop rates, while current_no_cash_proxy_alpha_AB has lower 90-day stop-hit risk and smaller worst sampled drawdown. The focused candidate_exhaustive run remains incomplete because the ETF finalist all-possible rolling rows were not available in compact evidence; do not treat this as final validation.
