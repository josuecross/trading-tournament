...
from strategy_lab.research_os.research.public_source_larry_connors_rsi2_bounded_bt_design import run
        ...
        json.dumps(
            {
                ...
                "similarity_hit_preserved": result["similarity_hit_preserved"],
