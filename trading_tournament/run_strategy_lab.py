...
ALLOWED_STATUSES = {
    ...
    "promotion_review_candidate_family",
    "continue_family",
    "reject_family",
    "needs_more_data",
    "evidence_missing",
    ...
    "next_family_to_review",
    "future_family_review",
    "future_benchmark_family",
    "future_review_candidate",
    "future_benchmark_or_control",
    "watchlist_no_more_rescue_now",
...
ALLOWED_NEXT = {
    ...
    "create_managed_futures_etf_wrapper_research_sample_prompt",
    "create_managed_futures_etf_wrapper_symbol_discovery_prompt",
    "create_promotion_review_for_managed_futures_etf_wrapper",
    "create_dual_momentum_paa_etf_wrapper_fast_exploration_review_prompt",
    "create_dual_momentum_paa_etf_wrapper_research_sample_prompt",
    "create_promotion_review_for_best_parallel_discovery_candidate",
    "create_candidate_exhaustive_prompt_for_qvm_quality_value_momentum_risk_adjusted_top2_v1",
    "repair_qvm_risk_adjusted_top2_promotion_review_diagnostics",
    "keep_qvm_quality_value_momentum_risk_adjusted_top2_v1_on_watchlist",
    "mark_qvm_quality_value_momentum_risk_adjusted_top2_v1_too_risky",
    "archive_qvm_quality_value_momentum_risk_adjusted_top2_v1_as_duplicate_diagnostic",
    "reject_qvm_quality_value_momentum_risk_adjusted_top2_v1",
    "archive_qvm_quality_value_momentum_top2_v1_as_duplicate_diagnostic",
    "mark_qvm_quality_value_momentum_top2_v1_too_risky",
    "create_promotion_review_for_qvm_quality_value_momentum_top2_v1",
    "create_candidate_exhaustive_prompt_for_lvq_lowvol_quality_spy_regime_v1",
    "keep_lvq_lowvol_quality_spy_regime_v1_on_watchlist",
    "mark_lvq_lowvol_quality_spy_regime_v1_too_slow",
    "archive_lvq_lowvol_quality_spy_regime_v1_as_duplicate_diagnostic",
    "mark_lvq_lowvol_quality_spy_regime_v1_too_risky",
    "reject_lvq_lowvol_quality_spy_regime_v1",
    "continue_next_approved_family_discovery_batch",
    "create_promotion_review_for_best_approved_cache_batch_2_candidate",
    "repair_approved_cache_batch_2_data_issue",
    "create_promotion_review_for_best_approved_cache_batch_3_candidate",
    "repair_approved_cache_batch_3_data_issue",
    "create_promotion_review_for_best_expanded_universe_batch_1_candidate",
    "repair_expanded_universe_batch_1_data_issue",
    "continue_best_parallel_discovery_family",
    "adjust_exploratory_gate_labels_not_thresholds",
    "move_to_dsr_top2_or_reassess_roadmap",
    ...
    "repair_dsr_top3_promotion_review_diagnostics",
    "keep_dsr_sector_top3_momentum_defensive_cash_v1_on_watchlist",
    "archive_dsr_sector_top3_momentum_defensive_cash_v1_as_dsr_duplicate_diagnostic",
    "mark_dsr_sector_top3_momentum_defensive_cash_v1_too_risky",
    "reject_dsr_sector_top3_momentum_defensive_cash_v1",
    "create_candidate_exhaustive_prompt_for_dsr_sector_top2_momentum_200d_bil_v1",
    "bootstrap_dsr_sector_etf_cache_before_dsr_top2_promotion_review",
    "rerun_dsr_sector_rotation_research_sample_for_top2_only",
    "repair_dsr_top2_promotion_review_diagnostics",
    "keep_dsr_sector_top2_momentum_200d_bil_v1_on_watchlist",
    "archive_dsr_sector_top2_momentum_200d_bil_v1_as_dsr_duplicate_diagnostic",
    "mark_dsr_sector_top2_momentum_200d_bil_v1_too_risky",
    "reject_dsr_sector_top2_momentum_200d_bil_v1",
    "create_static_all_weather_benchmark_lane_review_prompt",
    "keep_quality_momentum_on_watchlist",
    "run_active_sleeve_ensemble_discovery_batch",
    "create_promotion_review_for_best_active_sleeve_ensemble_candidate",
    "keep_active_sleeve_ensemble_as_benchmark_watchlist",
    "archive_active_sleeve_ensemble_lane_as_no_improvement",
    "repair_active_sleeve_ensemble_discovery_outputs",
    "run_breadth_state_regime_discovery_batch",
    "archive_stop_etf_wrapper_track",
    "promotion_review_for_selected_breadth_state_rows",
    "defer_commodity_wrapper_until_after_managed_futures_review",
    "defer_crypto_spot",
    "keep_individual_stock_momentum_blocked",
}
QUEUE_ACTIONS = {
    "improve_as_new_version",
    "create_gate0_memo",
